 ...
 * @Last Modified time: 2018-11-07 11:16:00
 */
        ...
        if(!$this->request->isPost()){return json(['code'=>2,'msg'=>'请求类型错误！']);}//请求类型错误
            ...
            switch ($log) {
                case 0:
                    ...
                    break;
                case 1:
                    return json(['code'=>2,'msg'=>'您已经注册过了！']);
                    break;
                case 2:
                    return json(['code'=>2,'msg'=>'您输入的账号格式错误！']);
                    break;
                default :
                    return json(['code'=>2,'msg'=>'未受理的请求！']);
            }
	...
	public function modify_pwd()
    {
        if(!$this->request->isPost()){return json(['code'=>2,'msg'=>'请求类型错误！']);}//请求类型错误
            ...
            if($data['password']!=$data['repassword']){
            	return 	json(['code'=>2,'msg'=>'两次输入的密码不一样！']);
            }
            ...
            if(cmf_password($data['old_password'])!=$user['user_pass']){
            	...
            	return json(['code'=>2,'msg'=>'原始密码输入不正确！']);
            }
