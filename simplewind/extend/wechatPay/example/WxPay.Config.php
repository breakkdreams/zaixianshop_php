...
class WxPayConfig extends WxPayConfigInterface
{
	...
	public function GetAppId()
	{
		...
		return $module_info['wechatpay_appid'];
	}
	public function GetMerchantId()
	{
		$module_info = getModuleConfig('wechat_pay','config','config.json');
        $module_info = json_decode($module_info,true);
		return $module_info['wechatpay_mchid'];		
	}
	...
	**/
	...
	public function GetKey()
	{
		$module_info = getModuleConfig('wechat_pay','config','config.json');
        $module_info = json_decode($module_info,true);
		return $module_info['wechatpay_key'];		
	}
	public function GetAppSecret()
	{
		$module_info = getModuleConfig('wechat_pay','config','config.json');
        $module_info = json_decode($module_info,true);
		return $module_info['wechatpay_appsecret'];		
	}
	...
	public function pkcs8()
	{
		$pkcs8 = dirname(dirname(__FILE__)).'\cert\public_pkcs8.pem';
		return $pkcs8;
	}
}
